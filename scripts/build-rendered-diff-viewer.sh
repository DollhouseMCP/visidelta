  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .compare { min-width: 0; min-height: 0; display: flex; flex-direction: column; }
      ...
      .stage { flex: 1 1 auto; display: grid; gap: 0; min-height: 0; grid-template-columns: minmax(0, 1fr); grid-template-rows: minmax(0, 1fr); }
